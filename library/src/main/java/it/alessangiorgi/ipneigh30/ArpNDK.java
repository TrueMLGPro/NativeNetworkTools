...
public class ArpNDK {
	...
	static {
		System.loadLibrary("nativenetworktools-android");
	}

	private static native int ARPFromJNI(int fd);
//	private static native String MACFromJNI();
//	private static native String getMACAddrNewMethod();
...
/*
	public static String getMacAddr() {
		String macAddr = MACFromJNI();

		if (Objects.equals(macAddr, "")) {
			Log.e(TAG, "getMacAddr: null");
			return macAddr;
		}
		Log.i(TAG, "getMacAddr: " + macAddr);

		return macAddr;
	}

	public static String getMacAddrNew() {
		return getMACAddrNewMethod();
	}
